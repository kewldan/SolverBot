...
content = ('👋 Привет, это бот для решения вариантов с сайта Сдам ГИА\n'
           'Донаты: https://pay.cloudtips.ru/p/34002994\n'
           'Когда наберется 1000₽ дам мануал на решение вариантов с телефона.\n'
           'Сейчас решать варианты через бота автоматически НЕЛЬЗЯ!\n'
